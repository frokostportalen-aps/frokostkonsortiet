...
/**
 * The marquee layout — the family default: two opposing bands of cards that
 * scroll on their own, so a long list of voices reads as a crowd. Sites with
 * few, named references use the carousel instead (see `Carousel.client.tsx`);
 * the dialect picks between them.
 */
export const TestimonialsMarquee: React.FC<VariantProps> = ({ heading, intro, items }) => {
