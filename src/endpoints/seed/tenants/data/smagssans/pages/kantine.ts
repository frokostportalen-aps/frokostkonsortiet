...
export const kantine: PageFactory = ({ tenantID, img }) => ({
  ...
  hero: hero.medium(
    ...
    richText(
      ...
      p('Lad Smagssans drive jeres kantine – med friske buffeter og faste menuer, tilpasset jeres rammer.'),
    ),
  ),
  layout: [
    content(
  ...
  meta: {
    title: 'Kantine',
    description: 'Kantinedrift fra Smagssans – friske buffeter og faste menuer tilpasset jeres rammer.',
    image: img('kantine'),
  },
})
