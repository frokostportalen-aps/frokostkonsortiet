...
export const catering: PageFactory = ({ tenantID, img }) => ({
  ...
  hero: hero.medium(
    ...
    richText(
      heading('h1', 'Catering'),
      p('Smagssans leverer catering til selskaber, receptioner og mærkedage – mad, der gør dagen til noget særligt.'),
    ),
  ),
  layout: [
    content(
  ...
  meta: {
    title: 'Catering',
    description: 'Catering fra Smagssans – selskabsmenuer, receptioner og mærkedage.',
    image: img('catering'),
  },
})
