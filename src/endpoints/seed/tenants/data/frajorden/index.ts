 ...
 * Frokostordning-fanen og FAQ — plus Ugens menu, som ikke skal skrives, fordi
 * køkkenet selv leverer indholdet. Kantinedrift, catering, bæredygtighed, om os
 * og kundeportalen var vores eget udkast og er taget ud, indtil der ligger
 * rigtig tekst — det gamle indhold ligger i backup/seed/ og i git.
 */
