...
// Placeholder shown while the image is loading. A soft warm-sand gradient in
// the brand family's palette, so lazy images read as "warm surface loading"
// instead of a dark foreign blob against the light themes.
const placeholderBlur =
  'data:image/svg+xml;base64,'
...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  // different screen sizes. The default is full-viewport width — `sizes` takes
  // lengths (vw/px), the browser multiplies by DPR itself. (The old default
  // emitted srcset-style `…w` descriptors, which are invalid in `sizes` and
  // made browsers fall back to 100vw with extra parsing noise.)
